...
namespace App\Http\Controllers\Website\Documents;
...
class DocumentsController extends WebsiteController
{
    /**
    ...
    public function showCategory(DocumentCategory $category)
    {
        ...
        $user = \Auth::user();
        $documents = (isset($user->id)) ? Document::where('created_by',$user->id)->get():[];
